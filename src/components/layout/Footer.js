 ...
 const Footer = () => {
   return (
     <Box mt="3rem" pt="3rem" px="0.9rem" bgcolor="#EDF1FF">
         <Stack pt="3rem" px="3rem"  direction="row" justifyContent="space-between">
            <Box pl="15px" pr="3rem" mb="3rem">
            <Box width='50px' marginBottom="1.5rem">
            ...
            <Box pl="15px" pr="15px" mb="3rem" ml="-80px">
            ...
            <Box pl="30px" mb="3rem">
                ...
                <Box mb="1rem">
                <TextField label="Your Name"  bgcolor="whitesmoke" />
                </Box>
                <Box mb="1rem">
                <TextField label="Your Email" bgcolor="whitesmoke" />
                </Box>
         ...
         <Stack direction="row" alignItems='center' mx="3rem" py="1.3rem">
