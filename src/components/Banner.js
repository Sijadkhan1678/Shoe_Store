    ...
    <Grid container px={4}>
      <Grid item lg={3.96} position='relative'>
        ...
        <Box sx={{
          ...
          <Typography variant='h5' sx={{ fontSize: 20, fontWeight: 400, color: 'white' }}>Nike Flash Be Seen</Typography>
        </Box>
      </Grid>
      ...
      <Grid item lg={8} position='relative'>
        <Grid item>
          ...
          <Box sx={{
            ...
            <Typography variant='h5' sx={{ fontSize: 22, fontWeight: 400, color: 'white' }}>Women's Training</Typography>
        ...
        <Grid container>
          <Grid item lg={6} position='relative'>
            ...
            <Box sx={{
              ...
              <Typography variant='h5' sx={{ mb: 1, fontSize: 20, fontWeight: 400, color: '#222' }}>Hello Summer 2019</Typography>
              <Typography variant='h2' sx={{ mb: 1, fontSize: 50, fontWeight: 700, color: '#222' }}>Extra 50%Off</Typography>
          ...
          <Grid item lg={6} position='relative'>
            ...
            <Box sx={{
              ...
              <Typography variant='h5' sx={{ fontSize: 20, fontWeight: 400, color: 'white' }}>Nike Shoes</Typography>
